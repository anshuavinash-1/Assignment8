...
class TaskApp:
    ...
    def show_task_list_screen(self):
        ...
        tk.Button(
            self.root, text="Add New Task", bg=self.button_color_green, fg=self.text_color, command=self.show_add_task_screen
        ).pack(pady=10)

        tk.Button(
            self.root, text="Filter Tasks", bg=self.button_color, fg=self.text_color, command=self.filter_tasks
        ).pack(pady=10)
        ...
        tk.Button(
            self.root, text="Delete Task", bg=self.button_color, fg=self.text_color, command=self.confirm_delete
        ).pack(pady=10)
